...
import { Activity, Cpu, HardDrive, TrendingUp, AlertTriangle, Bot, Network, CheckCircle, LayoutDashboard, Bell, BarChart3, Radio, Settings, Users } from 'lucide-react';
    ...
    return (
        <div className="relative w-full aspect-video rounded-xl border overflow-hidden"
            ...
            <div className="relative z-10 h-full flex">
                ...
                {/* Left Sidebar */}
                <div className="w-16 md:w-20 flex-shrink-0 p-3 md:p-4 border-r"
                     style={{
                    ...
                    <nav className="space-y-2 md:space-y-3">
                        {[
                            ...
                            { icon: <Activity size={16} />, label: 'Fleet', active: false },
                            { icon: <Bell size={16} />, label: 'Alerts', active: false },
                            { icon: <BarChart3 size={16} />, label: 'Analytics', active: false },
                            { icon: <Radio size={16} />, label: 'ROS', active: false },
                            { icon: <Users size={16} />, label: 'Team', active: false },
                            { icon: <Settings size={16} />, label: 'Settings', active: false }
                        ].map((item, idx) => (
                            <div
                                key={idx}
                                className="w-full aspect-square rounded-lg flex items-center justify-center cursor-pointer transition-all hover:scale-105"
                                style={{
                                    backgroundColor: item.active ? `${colors.primary}40` : 'transparent',
                                    color: item.active ? colors.light : 'white',
                ...
                <div className="flex-1 p-4 md:p-6 overflow-hidden">
                    ...
                    <div className="flex items-center justify-between mb-3 md:mb-4">
                        <div className="flex items-center gap-2">
                            <span className="text-white/80 text-sm md:text-base font-semibold">Dashboard</span>
                        </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-32 pointer-events-none"
                 style={{
                     background: `linear-gradient(to top, ${colors.forebackground}, transparent)`
                 }} />

            {/* Glow Effect */}
            <div
                className="absolute -bottom-20 left-1/2 transform -translate-x-1/2 w-96 h-96 opacity-20 blur-3xl pointer-events-none"
